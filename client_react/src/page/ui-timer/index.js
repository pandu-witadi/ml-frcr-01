...
const UiTimerApi = () => {
    ...
    const timerObjList = [
        ...
        {
            id: 1, text: "1 Seconds", value: 1
        },
        {
            id: 2, text: "5 Seconds", value: 5
        },
        {
            id: 3, text: "20 Seconds", value: 10
        },
        {
            id: 4, text: "30 Seconds", value: 30
        },
        {
            id: 5, text: "1 Minutes", value: 60
        },
        {
            id: 6, text: "2 Minutes", value: 120
        },
        {
            id: 7, text: "5 Minutes", value: 300
        },
    ]
    ...
    const [taskNum, setTaskNum] = useState(13)
    ...
    const createNewTask = () => {
        ...
        // console.log(baseURL + "/api/job/start")
        httpPost(baseURL + "/api/job/start", param).then((v) => {
            if (v.isError) {
    ...
    const checkTasksByTimer = () => {
        ...
        Object.keys(all_task).map((key_) => {
            ...
            if (task["status"] !== "SUCCESS") {
                httpGet(baseURL + "/api/job/status/" + task["task_id"]).then((v) => {
                    if (v.isError) {
                                    ...
                                    <Grid item key={key_}>
                                        <Card>
                                            <CardContent>
                                                ...
                                                <Typography>msg: {userTask[key_]["result"]["msg"]}</Typography>
                                            </CardContent>
                                        </Card>
                                    </Grid>)
                            })
